...
HFILES =	main.h graphic.h EntityData.h RoomData.h PlayerData.h game_math.h

CODEFILES   = 	main.c roomdata.c entitydata.c stage00.c graphic.c gfxinit.c game_math.c
